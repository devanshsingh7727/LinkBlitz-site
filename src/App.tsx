...
import { ChevronRight, Check, Play, ExternalLink, Heart, Star, Shield, Zap, Target, Menu, X } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Connect instantly with the click of a button. No manual work required.",
      color: "from-blue-500 to-purple-600"
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Smart Targeting",
      description: "Only works on people pages. Intelligent and precise targeting.",
      color: "from-purple-500 to-pink-600"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Safe & Secure",
      description: "Built with LinkedIn's best practices. Your account stays protected.",
  ...
  const testimonials = [
    {
      ...
      content: "LinkBlitz saved me hours of manual work. My network grew 300% in just one month!",
      rating: 5
    },
    {
      name: "Michael Chen",
      role: "Sales Manager",
      content: "The automation is seamless and safe. Highly recommend for anyone serious about networking.",
      rating: 5
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#demo" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">Demo</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md shadow-xl border-t">
            <div className="px-4 py-6 space-y-4">
              <a href="#features" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Features</a>
              <a href="#demo" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">Demo</a>
              <a href="#how-it-works" className="block text-gray-600 hover:text-gray-900 transition-colors duration-200">How It Works</a>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8 shadow-lg">
              ...
              <span className="text-sm font-medium text-gray-700">Now Available on Chrome Web Store</span>
            </div>

            {/* Title */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-6 tracking-tight">
              Automate Your
              <span className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 bg-clip-text text-transparent"> LinkedIn </span>
              Networking
            </h1>

            {/* Subtitle */}
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              Connect with thousands of professionals effortlessly. Grow your network 10x faster with smart automation.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Powerful automation tools designed to supercharge your LinkedIn networking while keeping your account safe.
            </p>
          </div>
      ...
      <section id="demo" className="py-16 lg:py-24 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Watch how easy it is to automate your LinkedIn connections and grow your professional network.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
                    ...
                    <div className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="text-white font-semibold text-sm">LinkBlitz Demo</div>
                            <div className="text-white/70 text-xs">Placeholder content for demonstration</div>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm lg:text-base">
                        See how LinkBlitz can help you connect with thousands of professionals automatically. 
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">10K+</div>
              ...
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">99.9%</div>
      ...
      <section id="how-it-works" className="py-16 lg:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Start automating your LinkedIn connections in under 5 minutes. No technical knowledge required.
            </p>
          </div>
